...
from zh import g2p as g2p_chinese
from en import g2p as g2p_english
# from jp import g2p as g2p_japanese
from symbols import (
    language_id_map,
...
if __name__ == "__main__":
    segments = parse_text_to_segments(
        "测试一下 Hugging face, BGM声音很大吗？那我改一下."  # noqa: E501
    )
    print(segments)
    ...
    print(clean_text("测试一下 Hugging face, BGM声音很大吗？那我改一下."))
